...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_plaintext.setGeometry(QtCore.QRect(170, 115, 431, 71))
        self.txt_plaintext.setObjectName("txt_plaintext")
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(440, 425, 75, 23))
        self.btn_decrypt.setObjectName("btn_decrypt")
        self.btn_encrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_encrypt.setGeometry(QtCore.QRect(210, 425, 75, 23))
        self.btn_encrypt.setObjectName("btn_encrypt")
        self.txt_key = QtWidgets.QLineEdit(self.centralwidget)
        self.txt_key.setGeometry(QtCore.QRect(170, 235, 431, 20))
        self.txt_key.setObjectName("txt_key")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(220, 50, 311, 41))
        font = QtGui.QFont()
        ...
        self.label_3.setGeometry(QtCore.QRect(60, 325, 51, 16))
        self.label_3.setObjectName("label_3")
        self.txt_ciphertext = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_ciphertext.setGeometry(QtCore.QRect(170, 295, 431, 71))
        self.txt_ciphertext.setObjectName("txt_ciphertext")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(60, 145, 47, 13))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(60, 235, 47, 13))
